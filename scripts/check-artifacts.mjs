...
assert.deepEqual(packaged.sort(),['.nojekyll','CNAME','assets','index.html','list','update','manifest.webmanifest','src','sw.js'].sort());
assert.deepEqual(await readFile('update/index.html'),await readFile('_site/update/index.html'));
